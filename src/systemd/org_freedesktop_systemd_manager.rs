// This code was autogenerated with `dbus-codegen-rust -g -d org.freedesktop.systemd1 -p /org/freedesktop/systemd1`, see https://github.com/diwic/dbus-rs
use dbus as dbus;
...
pub trait OrgFreedesktopSystemd1Manager {
    ...
    fn set_environment(&self, assignments: Vec<&str>) -> Result<(), dbus::Error>;
